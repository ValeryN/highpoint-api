...
Page.prototype.renderBlockContentInternal = function () { // @7:1
  ...
  self.writer.write(
    '<h2>Получение списка пользователей</h2><div class=\'request\'><div class=\'method\'>GET</div><div class=\'path\'>/users</div></div><table class=\'params\'><caption>GET параметры</caption><thead><tr><th>Название</th><th>Тип</th><th>Описание</th></tr></thead><tbody><tr><td><code>afterUserId</code></td><td><code>uint=</code></td><td><p>Идентификатор <a href="',
