...
Page.prototype.renderBlockContentInternal = function () { // @7:1
  ...
  self.writer.write(
    '<h2>Получение списка поинтов</h2><div class=\'request\'><div class=\'method\'>GET</div><div class=\'path\'>/points</div></div><table class=\'params\'><caption>GET параметры</caption><thead><tr><th>Название</th><th>Тип</th><th>Описание</th></tr></thead><tbody><tr><td><code>afterPointId</code></td><td><code>uint=</code></td><td><p>Идентификатор <a href="',
    ...
    '#User">User</a>&gt;=\n  }\n}</pre><p>Если задан GET параметр <code>includeUsers=1</code>, в ответе возвращаются пользователи, создавшие поинты. Ключом является идентификатор поинта, значением — объект пользователя.</p><h2>Лайк поинта</h2><div class=\'request\'><div class=\'method\'>POST</div><div class=\'path\'>/points/&lt;id&gt;/like</div></div><table class=\'params\'><caption>Параметры адреса</caption><thead><tr><th>Название</th><th>Тип</th><th>Описание</th></tr></thead><tbody><tr><td><code>id</code></td><td><code>uint</code></td><td>Идентификатор поинта</td></tr></tbody></table><p>Ответ:</p><pre js>{}</pre><h2>Анлайк поинта</h2><div class=\'request\'><div class=\'method\'>POST</div><div class=\'path\'>/points/&lt;id&gt;/unlike</div></div><table class=\'params\'><caption>Параметры адреса</caption><thead><tr><th>Название</th><th>Тип</th><th>Описание</th></tr></thead><tbody><tr><td><code>id</code></td><td><code>uint</code></td><td>Идентификатор поинта</td></tr></tbody></table><p>Ответ:</p><pre js>{}</pre>'
  );
}; // @122:1
